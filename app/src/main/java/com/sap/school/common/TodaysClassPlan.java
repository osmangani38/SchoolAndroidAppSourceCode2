...
public class TodaysClassPlan extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private Context mContext;
    List<ListItem> consolidatedList = new ArrayList<>();

    public TodaysClassPlan(Context context, List<ListItem> consolidatedList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case ListItem.TYPE_GENERAL:
                View v1 = inflater.inflate(R.layout.custom_todays_class_plan, parent,
                        false);
