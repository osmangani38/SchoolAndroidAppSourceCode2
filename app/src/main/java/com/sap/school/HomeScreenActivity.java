...
public class HomeScreenActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void ClassRoutinMethod() {
        ...
        LinearLayoutManager horizontalLayoutManagaer = new LinearLayoutManager(HomeScreenActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    private void Information() {
        ...
        //infoPojoClassArrayList.add(new InfoPojoClass("07",R.drawable.class_routine,"Notice"));
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.classPlanNavigationButton:
                startActivity(new Intent(getApplicationContext(),ClassPlanActivity.class));
                closeDrawer();
                break;
    ...
    private class InfoRecyclerViewAdapter extends RecyclerView.Adapter<InfoRecyclerViewAdapter.MyViewHolderClass>{
        ...
        @NonNull
        @Override
        public InfoRecyclerViewAdapter.MyViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_class_information_page_item, parent, false);
            return new InfoRecyclerViewAdapter.MyViewHolderClass(itemView);
        }

        @Override
        public void onBindViewHolder(@NonNull InfoRecyclerViewAdapter.MyViewHolderClass holder, final int position) {
            ...
            holder.linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                        startActivity(new Intent(getApplication(),SelectClassActivity.class));
                    }
                }
            });
    ...
    private class ClassOverviewRecyclerviewAdapter extends RecyclerView.Adapter<ClassOverviewRecyclerviewAdapter.MyViewHolderClass>{
        ...
        @NonNull
        @Override
        public ClassOverviewRecyclerviewAdapter.MyViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_class_overview_page_item, parent, false);
            return new ClassOverviewRecyclerviewAdapter.MyViewHolderClass(itemView);
        }

        @Override
        public void onBindViewHolder(@NonNull ClassOverviewRecyclerviewAdapter.MyViewHolderClass holder, final int position) {
    ...
    private class ClassRoutineRecyclerViewAdapter extends RecyclerView.Adapter<ClassRoutineRecyclerViewAdapter.MYViewHolderClass>{
        ...
        public MYViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int i) {
            ...
            return new ClassRoutineRecyclerViewAdapter.MYViewHolderClass(itemView);
        }
