...
public class ExamScheduleFragment extends Fragment {
    ...
    private void croutinInfo() {
        classRoutinePojoClassArrayList.add(new ClassRoutinePojoClass("Mathematics","Class - V | Section - B","11 am - 2.00 pm"));
        classRoutinePojoClassArrayList.add(new ClassRoutinePojoClass("Hindi","Class - V | Section - B","11 am - 2.00 pm"));
        classRoutinePojoClassArrayList.add(new ClassRoutinePojoClass("English","Class - V | Section - B","11 am - 2.00 pm"));
        classRoutinePojoClassArrayList.add(new ClassRoutinePojoClass("Life Science","Class - V | Section - B","11 am - 2.00 pm"));
    ...
    private void initView() {
        routinRecyclerView=(RecyclerView)view.findViewById(R.id.examRecyclerView);
    ...
    private class RoutineRecyclerViewAdapter extends RecyclerView.Adapter<RoutineRecyclerViewAdapter.MyViewHolderClass>{
        ...
        public RoutineRecyclerViewAdapter.MyViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int i) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_exam_page, parent, false);
